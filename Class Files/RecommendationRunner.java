...
/**
 * Write a description of RecommendRunner here.
 * 
 * @author (your name) 
...
public class RecommendationRunner implements Recommender{
   public void printRecommendationsFor(String webRaterID){
       ...
       int numSimilarRaters = 3;
       int minimalRaters = 3;
       
       ArrayList<Rating> rList = fr.getSimilarRatings(webRaterID, numSimilarRaters, minimalRaters);
       if(rList.size() == 0){
        printError();
        }
       else{
